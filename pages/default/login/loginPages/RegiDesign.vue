  ...
  <div class="container">
    ...
    <section class="content">
      <form action="">
        ...
        <div class="form_item">
          <div class="form_item_left">
            <p>公司 / 个人所在从城市<span class="red">*</span></p>
            <v-distpicker
        ...
        <div class="form_item">
          <div class="form_item_row">
            <p>过往案例叙述</p>
            <textarea
              placeholder="请输入过往案例叙述"
              :value="formData.remark"
              @input="e => setValue({ key: 'remark', value: e.target.value })"
            />
          </div>
        </div>
      </form>
...
export default {
  ...
  computed: {
    formData () {
      console.log(this.$store.state.registerDesigner)
      return this.$store.state.registerDesigner
    },
  ...
  methods: {
    ...
    async submit () {
      await this.$store.dispatch('registerDesigner/submitData', 'PC官网')
