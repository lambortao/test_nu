    ...
    <section class="content">
      <form>
          ...
          <div class="form_item_right">
            ...
            <div class="select_box">
              <Input
                ...
                :disabled="true"
                size="short"
                @update:value="value => setValue({ key: 'phoneNumber', value })"
              />
              <small-button class="default-border" size="short">
                修改
              </small-button>
            </div>
          </div>
        ...
        <div class="upload_box">
          ...
          <div class="upload">
            <Upload @getUploadList="getUploadList" />
          </div>
        </div>
        <div class="submit">
          <pc-button
...
export default {
  ...
  methods: {
    ...
    async submit () {
      await this.$store.dispatch('registerMember/submitData')
