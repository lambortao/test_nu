...
export default {
  computed: {
    ...
    filterDataList () {
      ...
      // const colorValue = this.$store.state.productColor.value
      // const textureValue = this.$store.state.productTexture.value
  ...
  methods: {
    ...
    async deleteFilter (alias) {
      ...
      this.$store.dispatch('productList/useRequestParam', { router: this.$router })
    }
  }
}
</script>
