...
<script>
// import Dialog from '~/componentsEn/common/Dialog.vue'
import ArticleList from '~/componentsEn/common/List/ArticleList.vue'
import MobileFavorite from '~/pagesEn/mobile/favorite/index.vue'
export default {
  name: 'FavoritePage',
  components: {
    ArticleList,
  ...
  methods: {
    ...
    toInspiration () {
      this.$router.push('/en/inspiration')
    }
  }
}
</script>
