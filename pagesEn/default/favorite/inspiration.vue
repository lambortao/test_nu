...
<script>
import InspirList from '~/componentsEn/common/List/inspirList.vue'
import Dialog from '~/componentsEn/common/Dialog/Dialog.vue'
import dialogList from '~/componentsEn/common/List/dialogList.vue'
import MobileInspiration from '~/pagesEn/mobile/inspiration/index.vue'
export default {
