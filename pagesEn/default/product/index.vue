<template>
  <div>
    <div
      class="site-is-default product-container"
      @click.self="selectSection(null)"
    >
      ...
      <div class="product-list-content">
        ...
        <template v-else>
          <product-list
            v-if="productListData.list.length"
...
/** 手机端 */
import MobileProduct from '@/pagesEn/mobile/product/index.vue'
...
export default {
  ...
  async fetch () {
    /** 获取所有的分类数据 */
    await this.initFilterList('/en/product')
