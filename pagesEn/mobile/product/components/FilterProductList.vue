    ...
    <div v-for="product in productList" :key="product.alias" class="product-block">
      <header>
        ...
        <div
          ...
          @click="setSelectedProductListEvent({ mode: 'all', value: product.allChildAlias,label:product.nameen,isSelect:hasAll(product.allChildAlias) })"
        >
          <span />
          <p>All</p>
        </div>
